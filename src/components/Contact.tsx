      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-white tracking-tight mb-4">
            Let's Connect <br />
            <span className="gold-gradient-text">About Opportunities</span>
          </h2>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="p-4 rounded-xl bg-[#121222] border border-white/10 flex items-center gap-3.5">
              ...
              <div>
                ...
                <div className="text-white text-xs sm:text-sm">{PERSONAL_INFO.location}</div>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl bg-[#c9a227]/10 border border-[#c9a227]/30 flex items-start gap-3 text-xs text-gray-300">
              ...
              <div>
                <strong className="text-white">Open to opportunities:</strong>{" "}
                Full-time roles, freelance projects, and remote collaboration.
                Response within 24h.
              </div>
            </div>
          </div>
            ...
            <div className="rounded-3xl bg-[#121222] border border-[#c9a227]/35 p-6 sm:p-10 shadow-2xl shadow-black/80 corner-bracket always-active">
              {!sent ? (
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  ...
                  <div>
                    <label htmlFor="contact-service" className="block text-xs font-mono text-gray-300 mb-1.5">
                      Regarding
                    </label>
                    <select
                      id="contact-service"
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-300 text-xs sm:text-sm max-w-md mx-auto mb-6">
                    ...
                    <span className="text-[#f0d060] font-mono">{form.email}</span>
                  </p>
                  <button
                    onClick={() => {
                      setSent(false);
