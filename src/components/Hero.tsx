        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl text-white tracking-tight leading-[1.08] mb-4">
              {HERO.greeting} <br />
              <span className="gold-gradient-text">{PERSONAL_INFO.name}</span>
            </h1>
            ...
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-xl mb-8">
              {HERO.bioBefore}{" "}
              <strong className="text-white font-semibold">{HERO.bioHighlight}</strong>{" "}
              {HERO.bioAfter}{" "}
              <span className="text-[#f0d060]">{HERO.bioTools}</span>
              {HERO.bioEnd}
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-6 border-t border-white/10 w-full max-w-xl">
              <div>
                <div className="font-display font-extrabold text-2xl text-[#f0d060]">{PERSONAL_INFO.experienceYears}</div>
                <div className="text-xs text-gray-400 font-mono mt-0.5">{HERO.metric1Label}</div>
              </div>
              <div>
                <div className="font-display font-extrabold text-2xl text-white">{PERSONAL_INFO.projectsDelivered}</div>
                <div className="text-xs text-gray-400 font-mono mt-0.5">{HERO.metric2Label}</div>
              </div>
              <div>
                <div className="font-display font-extrabold text-2xl text-[#f0d060]">{PERSONAL_INFO.toolsMastered}</div>
                <div className="text-xs text-gray-400 font-mono mt-0.5">{HERO.metric3Label}</div>
              </div>
              <div>
                <div className="font-display font-extrabold text-2xl text-white">{PERSONAL_INFO.clientSatisfaction}</div>
                <div className="text-xs text-gray-400 font-mono mt-0.5">{HERO.metric4Label}</div>
              </div>
            </div>
          </div>
