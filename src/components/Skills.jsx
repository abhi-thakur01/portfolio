...
export function Skills() {
  return (
    <section id="skills" className="py-14 sm:py-20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 sm:gap-3">
            {(skillIcons || []).map((skill, i) => (
              <Reveal key={skill.name} from="up" delay={i * 60}>
                <div className="flex flex-col items-center gap-1.5 sm:gap-2 p-3 sm:p-4 rounded-xl bg-[#111827] border border-white/8 hover:border-blue-500/40 hover:-translate-y-0.5 transition-all group">
                  <div
